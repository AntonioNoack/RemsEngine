...
object RayTracing {
    ...
    val glslTLASIntersection = "" +
            ...
            "               intersectBLAS(v01.x, localPos, localDir, 1.0 / localDir, localDistance, localNormal, blasCtr, trisCtr);\n" +
            ...
            "                   float worldDistance1 = localDistance * length(matMul(mat3x3(localToWorld), localDir));\n" +
