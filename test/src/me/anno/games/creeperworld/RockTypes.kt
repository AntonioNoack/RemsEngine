...
object RockTypes {
    ...
    val skyColor = ImageCache[res.getChild("textures/Clouds.jpg"), false]!!
    ...
    val stoneTexture = ImageCache[res.getChild("textures/Stone.png"), false]!!
    val stone = RockType(1, NameDesc("Stone"), mapOf(hardness to 0.7f), stoneTexture)
    val rockTexture = ImageCache[res.getChild("textures/Rock.png"), false]!!
