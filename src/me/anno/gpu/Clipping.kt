...
object Clipping {
    ...
    @JvmStatic
    inline fun clip(x: Int, y: Int, w: Int, h: Int, crossinline render: () -> Unit) {
    ...
    @JvmStatic
    inline fun clip2(x0: Int, y0: Int, x1: Int, y1: Int, crossinline render: () -> Unit) =
        clip(x0, y0, x1 - x0, y1 - y0, render)

    @JvmStatic
    inline fun clip2Save(x0: Int, y0: Int, x1: Int, y1: Int, crossinline render: () -> Unit) {
        val w = x1 - x0
        val h = y1 - y0
        if (w > 0 && h > 0) {
