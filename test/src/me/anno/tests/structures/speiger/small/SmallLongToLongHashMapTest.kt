package me.anno.tests.structures.speiger.small
...
class SmallLongToLongHashMapTest {

    private fun createInstance() = SmallLongToLongMap(-1L)
    ...
    fun testGetOrPut() {
        val n = 1000
        val map = createInstance()
        val timesCalculated = IntArray(n - 1)
        fun fib(i: Int): Long {
