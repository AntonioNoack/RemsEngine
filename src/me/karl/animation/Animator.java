...
public class Animator {
	...
	public void update(double time) {
		...
		animationTime = (float) (time % currentAnimation.getLength());
		if(animationTime < 0f) animationTime += currentAnimation.getLength();
		Map<String, Matrix4f> currentPose = calculateCurrentAnimationPose();
		applyPoseToJoints(currentPose, entity.getRootJoint(), new Matrix4f());
	}
	...
	private void increaseAnimationTime() {
		animationTime = (System.currentTimeMillis() % (int) 1e6) * 1e-3f;//DisplayManager.getFrameTime();
