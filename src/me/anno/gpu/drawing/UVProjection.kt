...
enum class UVProjection(val id: Int, val doScale: Boolean, val naming: NameDesc, val mesh: Mesh) {
    ...
    Equirectangular(1, false, NameDesc("Full Cubemap", "Earth-like projection, equirectangular", ""), CubemapModel),
    TiledCubemap(2, false, NameDesc("Tiled Cubemap", "Cubemap with 6 square sides", ""), CubemapModel);
}