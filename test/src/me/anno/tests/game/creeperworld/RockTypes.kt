...
object RockTypes {
    ...
    val stoneTexture = ImageCache[FileReference.getReference("res://textures/Stone.png"), false]!!
    val stone = RockType(1, NameDesc("Stone"), mapOf(hardness to 0.7f), stoneTexture)
    val rockTexture = ImageCache[FileReference.getReference("res://textures/Rock.png"), false]!!
