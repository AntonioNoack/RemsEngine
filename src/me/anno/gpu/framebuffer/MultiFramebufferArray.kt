 ...
 *
 *  todo test this abomination XD
 * */
class MultiFramebufferArray(
    name: String,
    ...
    init {
        ...
        targetsI = createArrayList(targetCount) { targetIndex ->
            ...
            FramebufferArray(
                "$name/$targetIndex", w, h, layers, samples,
    ...
    override fun toString(): String {
        return "MultiArray(\"$name\", $width x $height x $samples, [${targets.joinToString { it.name }}], $depthBufferType)"
    }
}