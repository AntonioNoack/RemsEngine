...
/**
 * todo instead of operating on triangles,
 *  use the existing triangles to define a distance field,
 *  operate on that distance field,
 *  and then convert it back to triangles
 *
 * todo also disable/implement LODs properly(???)
 * */
class TerrainEditModeV3 : Component(), CustomEditMode {

    companion object {
        private val LOGGER = LogManager.getLogger(TerrainEditModeV3::class)
    }
