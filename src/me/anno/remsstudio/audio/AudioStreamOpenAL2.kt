...
class AudioStreamOpenAL2(
    ...
    listener: Camera,
    speed: Double
) : AudioStream2(file, repeat, getIndex(startTime, speed, playbackSampleRate), meta, sender, listener, speed) {
    ...
    companion object {
        private val LOGGER = LogManager.getLogger(AudioStreamOpenAL2::class)
    }
