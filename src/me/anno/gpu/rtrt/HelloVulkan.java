...
public final class HelloVulkan {
    ...
    private void demo_init_vk() {
        try (MemoryStack stack = stackPush()) {
            ...
            if (VALIDATE) {
                ...
                if (ip.get(0) > 0) {
                    VkLayerProperties.Buffer availableLayers = VkLayerProperties.create(ip.get(0));
            ...
            if (ip.get(0) != 0) {
                VkExtensionProperties.Buffer instance_extensions = VkExtensionProperties.create(ip.get(0));
            ...
            VkInstanceCreateInfo inst_info = VkInstanceCreateInfo.create()
                    // .sType$Default()
                    .pNext(NULL)
                    .flags(0)
            ...
            if (VALIDATE) {
                dbgCreateInfo = VkDebugReportCallbackCreateInfoEXT.create()
                        // .sType$Default()
                        .pNext(NULL)
            ...
            if (ip.get(0) > 0) {
                VkExtensionProperties.Buffer device_extensions = VkExtensionProperties.create(ip.get(0));
    ...
    private void demo_init_device() {
        try (MemoryStack stack = stackPush()) {
            ...
            extension_names.flip();
            VkDeviceCreateInfo device = VkDeviceCreateInfo.create()
                    // .sType$Default()
                    .pNext(NULL)
                    .flags(0)
    ...
    private void demo_init_vk_swapchain() {
        ...
        try (MemoryStack stack = stackPush()) {
            ...
            VkSurfaceFormatKHR.Buffer surfFormats = VkSurfaceFormatKHR.create(ip.get(0));
    ...
    private void demo_set_image_layout(long image, int aspectMask, int old_image_layout, int new_image_layout, int srcAccessMask) {
        try (MemoryStack stack = stackPush()) {
            if (setup_cmd == null) {
                VkCommandBufferAllocateInfo cmd = VkCommandBufferAllocateInfo.create()
                        // .sType$Default()
                        .pNext(NULL)
            ...
            VkImageMemoryBarrier.Buffer image_memory_barrier = VkImageMemoryBarrier.create(1)
                    // .sType$Default()
                    .pNext(NULL)
    ...
    private void demo_prepare_buffers() {
        ...
        try (MemoryStack stack = stackPush()) {
            ...
            VkSurfaceCapabilitiesKHR surfCapabilities = VkSurfaceCapabilitiesKHR.create();
            ...
            VkExtent2D swapchainExtent = VkExtent2D.create();
            ...
            VkSwapchainCreateInfoKHR swapchain = VkSwapchainCreateInfoKHR.create()
                    // .sType$Default()
                    .surface(surface)
            ...
            for (int i = 0; i < swapchainImageCount; i++) {
                ...
                VkImageViewCreateInfo color_attachment_view = VkImageViewCreateInfo.create()
                        // .sType$Default()
                        .pNext(NULL)
                        .flags(0)
    ...
    private void demo_prepare_depth() {
        ...
        try (MemoryStack stack = stackPush()) {
            VkImageCreateInfo image = VkImageCreateInfo.create()
                    // .sType$Default()
                    .pNext(NULL)
            ...
            VkMemoryRequirements mem_reqs = VkMemoryRequirements.create();
            vkGetImageMemoryRequirements(device, depth.image, mem_reqs);

            /* select memory size and type */
            VkMemoryAllocateInfo mem_alloc = VkMemoryAllocateInfo.create()
                    // .sType$Default()
                    .pNext(NULL)
            ...
            /* create image view */
            VkImageViewCreateInfo view = VkImageViewCreateInfo.create()
                    // .sType$Default()
                    .pNext(NULL)
                    .flags(0)
                    .image(depth.image)
    ...
    private void demo_prepare_texture_image(
        ...
        try (MemoryStack stack = stackPush()) {
            VkImageCreateInfo image_create_info = VkImageCreateInfo.create()
                    // .sType$Default()
                    .pNext(NULL)
                    .imageType(VK_IMAGE_TYPE_2D)
                    .format(tex_format)
            ...
            if ((required_props & VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT) != 0) {
                VkImageSubresource subres = VkImageSubresource.create()
                        .aspectMask(VK_IMAGE_ASPECT_COLOR_BIT)
                        .mipLevel(0)
                        .arrayLayer(0);

                VkSubresourceLayout layout = VkSubresourceLayout.create();
        ...
        try (MemoryStack stack = stackPush()) {
            ...
            for (int i = 0; i < DEMO_TEXTURE_COUNT; i++) {
                if ((props.linearTilingFeatures() & VK_FORMAT_FEATURE_SAMPLED_IMAGE_BIT) != 0 && !USE_STAGING_BUFFER) {
                    ...
                    VkImageCopy.Buffer copy_region = VkImageCopy.create(1)
                ...
                VkSamplerCreateInfo sampler = VkSamplerCreateInfo.create()
                        // .sType$Default()
                        .pNext(NULL)
    ...
    private void demo_prepare_descriptor_layout() {
        try (MemoryStack stack = stackPush()) {
            VkDescriptorSetLayoutCreateInfo descriptor_layout = VkDescriptorSetLayoutCreateInfo.create()
                    ...
                    .flags(0)
                    .pBindings(
                            VkDescriptorSetLayoutBinding.create(1)
                                    .binding(0)
            ...
            VkPipelineLayoutCreateInfo pPipelineLayoutCreateInfo = VkPipelineLayoutCreateInfo.create()
                    // .sType$Default()
                    .pNext(NULL)
                    .pSetLayouts(layouts);
    ...
    private void demo_prepare_render_pass() {
        try (MemoryStack stack = stackPush()) {
            ...
            VkSubpassDescription.Buffer subpass = VkSubpassDescription.create(1)
                    ...
                    .pColorAttachments(
                            VkAttachmentReference.create(1)
                                    .attachment(0)
    ...
    private void demo_prepare_pipeline() {
        ...
        try (MemoryStack stack = stackPush()) {
            VkGraphicsPipelineCreateInfo.Buffer pipeline = VkGraphicsPipelineCreateInfo.create(1);
            ...
            pipeline
                    ...
                    .pColorBlendState(
                            VkPipelineColorBlendStateCreateInfo.create()
                                    // .sType$Default()
                                    .pAttachments(
                                            VkPipelineColorBlendAttachmentState.create(1)
                                                    .colorWriteMask(0xf)
                                                    .blendEnable(false)
                                    ))
                    .pDynamicState(
            ...
            VkPipelineCacheCreateInfo pipelineCacheCI = VkPipelineCacheCreateInfo.create()
                    // .sType$Default()
                    ;
    ...
    private void demo_prepare_descriptor_set() {
        try (MemoryStack stack = stackPush()) {
            ...
            VkDescriptorImageInfo.Buffer tex_descs = VkDescriptorImageInfo.create(DEMO_TEXTURE_COUNT);
            for (int i = 0; i < DEMO_TEXTURE_COUNT; i++) {
                tex_descs.get(i)
            ...
            VkWriteDescriptorSet.Buffer write = VkWriteDescriptorSet.create(1)
                    // .sType$Default()
                    .dstSet(desc_set)
                    .descriptorType(VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER)
    ...
    private void demo_prepare() {
        try (MemoryStack stack = stackPush()) {
            VkCommandPoolCreateInfo cmd_pool_info = VkCommandPoolCreateInfo.create()
                    // .sType$Default()
                    .pNext(NULL)
    ...
    private void demo_draw_build_cmd() {
        try (MemoryStack stack = stackPush()) {
            ...
            VkClearValue.Buffer clear_values = VkClearValue.create(2);
            ...
            VkImageMemoryBarrier.Buffer prePresentBarrier = VkImageMemoryBarrier.create(1)
                    // .sType$Default()
                    .pNext(NULL)
