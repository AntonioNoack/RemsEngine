...
open class Matrix4f {
    ...
    private fun rotateXInternal(ang: Float, dst: Matrix4f): Matrix4f {
        ...
        val lm22 = m22
        val lm23 = m23
        return dst._m20(lm10 * -sin + lm20 * cos)._m21(lm11 * -sin + lm21 * cos)._m22(lm12 * -sin + lm22 * cos)
    ...
    private fun rotateXYZInternal(angleX: Float, angleY: Float, angleZ: Float, dst: Matrix4f): Matrix4f {
        ...
        return dst._m20(m00 * sinY + nm20 * cosY)._m21(m01 * sinY + nm21 * cosY)._m22(m02 * sinY + nm22 * cosY)
