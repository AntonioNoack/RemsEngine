...
import org.lwjgl.util.tinyexr.TinyEXR.InitEXRImage
import org.lwjgl.util.tinyexr.TinyEXR.LoadEXRImageFromMemory
import org.lwjgl.util.tinyexr.TinyEXR.LoadEXRMultipartImageFromMemory
import org.lwjgl.util.tinyexr.TinyEXR.ParseEXRHeaderFromMemory
import org.lwjgl.util.tinyexr.TinyEXR.ParseEXRMultipartHeaderFromMemory
import org.lwjgl.util.tinyexr.TinyEXR.ParseEXRVersionFromMemory
import org.lwjgl.util.tinyexr.TinyEXR.TINYEXR_ERROR_INVALID_ARGUMENT
import org.lwjgl.util.tinyexr.TinyEXR.TINYEXR_ERROR_INVALID_DATA
import org.lwjgl.util.tinyexr.TinyEXR.TINYEXR_ERROR_INVALID_EXR_VERSION
import org.lwjgl.util.tinyexr.TinyEXR.TINYEXR_ERROR_INVALID_HEADER
import org.lwjgl.util.tinyexr.TinyEXR.TINYEXR_ERROR_INVALID_MAGIC_NUMBER
import org.lwjgl.util.tinyexr.TinyEXR.TINYEXR_ERROR_INVALID_PARAMETER
import org.lwjgl.util.tinyexr.TinyEXR.TINYEXR_ERROR_UNSUPPORTED_FEATURE
import org.lwjgl.util.tinyexr.TinyEXR.TINYEXR_ERROR_UNSUPPORTED_FORMAT
import org.lwjgl.util.tinyexr.TinyEXR.TINYEXR_PIXELTYPE_FLOAT
import org.lwjgl.util.tinyexr.TinyEXR.TINYEXR_PIXELTYPE_HALF
import org.lwjgl.util.tinyexr.TinyEXR.TINYEXR_SUCCESS
import org.lwjgl.util.tinyexr.TinyEXR.nFreeEXRErrorMessage
...
object EXRReader {
    ...
    private fun readImage(
        ...
        val channelNames = List(numChannels) {
        ...
        var floats: List<FloatBuffer> = List(numChannels) { channelIndex ->
