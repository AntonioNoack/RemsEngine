...
fun main() {
    ...
    val forceFieldMaterial = Material().apply {
        ...
        shader = object : ECSMeshShader("ForceField") {
    ...
    scene.add(Entity("ForceField", MeshComponent(createUVSphere(30, 30), forceFieldMaterial)).apply {
        position = position.set(+1.0, 0.0, 0.0)
    })
