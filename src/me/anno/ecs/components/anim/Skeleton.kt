...
class Skeleton : PrefabSaveable() {
    ...
    fun draw(shader: Shader, stack: Matrix4x3f, skinningMatrices: Array<Matrix4x3f>?) {
        if (mesh == null) {
            mesh = Mesh()
            mesh!!.positions = FloatArray(bones.size * boneMeshVertices.size)
        ...
        generateSkeleton(bones, bonePositions, mesh.positions!!)
    ...
    companion object {
        ...
        fun generateSkeleton(bones: List<Bone>, bonePositions: Array<Vector3f>, positions: FloatArray) {
