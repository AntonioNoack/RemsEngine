                                   ...
                                   WPARAM wParam, LPARAM lParam)
{
    ...
    switch (uMsg)
    {
		...
		// Antonio ANNO
		// from the Windows 7 touch example
        ...
        case WM_TOUCH:
        {
            ...
            if (GetTouchInputInfo((HTOUCHINPUT)lParam, numInputs, ti, sizeof(TOUCHINPUT)))
			{
                ...
                for (unsigned int i = 0; i < numInputs; ++i)
                {
					...
					if (reportedIndex < 0) reportedIndex += 10000;
					if (reportedIndex < 0) reportedIndex = 0;// shouldn't happen...
					reportedIndex++;// +1 so the window pointer is larger than usual
