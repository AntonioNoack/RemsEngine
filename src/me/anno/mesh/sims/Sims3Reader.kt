...
object Sims3Reader {
    ...
    private val LOGGER = LogManager.getLogger(Sims3Reader::class)

    // it would be interesting to read files from the Sims
    // a) we could support existing custom content
    // b) we could support meshes from The Sims -> nah, too many GB to read, and it's pretty complex anyways
