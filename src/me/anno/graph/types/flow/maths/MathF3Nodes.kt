...
class MathF13Node : MathNode<FloatMathsUnary>(dataF13), EnumNode, GLSLExprNode {
...
class MathF23Node : MathNode<FloatMathsBinary>(dataF23), EnumNode, GLSLExprNode {
    override fun compute(graph: FlowGraph) {
        val a = getInput(graph, 0) as Vector3f
...
class MathF33Node : MathNode<FloatMathsTernary>(dataF33), EnumNode, GLSLExprNode {
    override fun compute(graph: FlowGraph) {
        val a = getInput(graph, 0) as Vector3f
        val b = getInput(graph, 1) as Vector3f
