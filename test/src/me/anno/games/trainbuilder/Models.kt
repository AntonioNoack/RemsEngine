...
).map { vehiclesFolder.getChild(it) }
...
val coalCarrierModels = listOf(
    vehiclesFolder.getChild("SM_Veh_Carriage_Coal_01.prefab")
)
...
val envModels = listOf(
    ...
    "SM_Env_Track_Corner_01.prefab", "SM_Env_Track_Corner_02.prefab", "SM_Env_Track_Corner_03.prefab",
    ...
    "SM_Env_Track_Straight_01.prefab", // full length
    "SM_Env_Track_Straight_02.prefab", // half-length
