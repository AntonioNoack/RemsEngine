...
class ECSTypeLibrary(val rootEntity: RootEntity, val isGaming: Boolean) {

    val typeList = listOf<Pair<String, () -> Panel>>(
        Dict["Scene View", "ui.customize.sceneView"] to { SceneView(DefaultConfig.style) },
        Dict["Tree View", "ui.customize.treeView"] to { ECSTreeView(rootEntity, isGaming, DefaultConfig.style) },
