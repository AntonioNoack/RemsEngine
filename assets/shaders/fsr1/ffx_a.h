...
//------------------------------------------------------------------------------------------------------------------------------
 ...
 vec3 ASatF3(vec3 x){return clamp(x,vec3(0.0),vec3(1.0));}
//------------------------------------------------------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------------------------------------------------------
 ...
 vec3 AGtZeroF3(vec3 m){return ASatF3(m*vec3(A_INFP_F));}
...
//------------------------------------------------------------------------------------------------------------------------------
 vec3 APrxMedRcpF3(vec3 a){vec3 b=AF3_AU3(uvec3(0x7ef19fffu)-AU3_AF3(a));return b*(-b*a+vec3(2.0));}
