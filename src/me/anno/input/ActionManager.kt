...
object ActionManager {
    ...
    fun init(){
        ...
        keyMap["global.z.p.${Modifiers[true, false]}"] = "Undo"
        keyMap["global.z.p.${Modifiers[true, true]}"] = "Redo"
        keyMap["global.y.p.${Modifiers[true, false]}"] = "Undo"
        keyMap["global.y.p.${Modifiers[true, true]}"] = "Redo"
