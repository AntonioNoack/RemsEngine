...
object RayIntersection {
    ...
    /**
     * Finds the closest positions of the rays (pos0, dir0) and (pos1, dir1).
     * Returns the parameters for these positions, meaning closest0 = pos0+dir0*dst.x and closest1 = pos1+dir1*dst.y.
     * Returns whether a result was found. No result can be found if the rays are close to being parallel.
     *
     * Neither dir0 nor dir1 need to be normalized.
     * */
    @JvmStatic
    fun rayIntersection(
