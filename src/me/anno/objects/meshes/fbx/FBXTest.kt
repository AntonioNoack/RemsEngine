...
fun invertInt(l: UInt): UInt {
    return (invertShort(l.shr(16).toUShort()).toUInt() + invertShort(l.toUShort()).toUInt().shl(16))
}

fun invertLong(l: ULong): ULong {
    return (invertInt(l.shr(32).toUInt()).toULong() + invertInt(l.toUInt()).toULong().shl(32))
}
